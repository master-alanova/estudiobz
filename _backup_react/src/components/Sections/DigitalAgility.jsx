...
const DigitalAgility = () => {
    return (
        <section id="gestiones" className="py-20 bg-secondary relative overflow-hidden text-white">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-600/20 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none"></div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    >
                        <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 relative">
                            <div className="absolute -top-6 -right-6 w-20 h-20 bg-primary rounded-2xl rotate-12 flex items-center justify-center shadow-lg">

...
const Services = () => {
    ...
    const autoServices = [
        ...
        { name: "Cédulas", icon: <FileCheck className="w-5 h-5" /> },
        ...
        <section id="servicios" className="py-20 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-contrast mb-4">Nuestros Servicios</h2>
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-contrast rounded-2xl p-8 shadow-sm text-white relative overflow-hidden"
                    >
                        {/* Decorative background */}
                        <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>

                        <div className="flex items-center gap-4 mb-8 relative z-10">
                            <div className="p-3 text-contrast bg-primary rounded-lg">

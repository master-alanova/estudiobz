            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.h1
                        ...
                        className="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary tracking-tight mb-6 leading-tight"
                    >
                    ...
                    >
                        Equipo interdisciplinario enfocado en excelencia jurídica y gestión automotor humana.
                    </motion.p>
